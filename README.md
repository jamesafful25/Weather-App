...
Features
    ...
    ⛅ Current Weather Display – Shows temperature, "feels like", humidity, wind, cloudiness, pressure, sunrise, sunset, and weather  
      description.
...
How it Works
      ...
      The user can search for a city or use geolocation to get their current weather.
       ...
       Displays current weather details, including temperature, feels like, humidity, wind, cloudiness, pressure, sunrise, sunset, and weather  
       description.
